  ...
  return (
    <div>
      <Head>
        ...
        <meta name="description" content="Privacy policy for P2P Alerts." />
      </Head>
      <Navbar />
      <div className={contentStyles.content}>
        ...
        <ul>
          ...
          <li>
            <strong>Application</strong> refers to <strong>P2P Alerts</strong>{" "}
            Mobile Application, the software program provided by the owner of
            the app.
          </li>
          <li>
            <strong>Company</strong> (referred to as either "the Company", "We",
            "Us" or "Our" in this Agreement) refers to the owner of the P2P
            Alerts.
          </li>
          <li>
        ...
        <p>
          ...
          diagnostic data or the input data for the application’s running
          appropriately.
        </p>
        <p>
          ...
          Your mobile device, Your mobile operating system, unique device
          identifiers and other diagnostic data. We may also collect information
          that You access the Service by or through a mobile device.
        </p>
        ...
        <ul>
          <li>By email: <strong>bridgelockapp@gmail.com</strong></li>
        </ul>
      </div>
    </div>
  );
